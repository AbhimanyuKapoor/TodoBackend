...
public class TaskList {
    ...
    //mappedBy: "look for the instance variable taskList on the Task class for  more info about this relationship"
    ...
    /*
    CascadeType.REMOVE: When we delete a taskList, all tasks it contains will be deleted too
    CascadeType.PERSIST: When we save a taskList, any new tasks it contains will be saved too
     */
